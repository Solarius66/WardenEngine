/****************************************************************************
** Meta object code from reading C++ file 'savebutton.h'
**
...
#include "../Warden_Software/savebutton.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'savebutton.h' doesn't include <QObject>."
...
const QMetaObject SaveButton::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_SaveButton.data,
      qt_meta_data_SaveButton,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SaveButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SaveButton.stringdata0))
        return static_cast<void*>(const_cast< SaveButton*>(this));
