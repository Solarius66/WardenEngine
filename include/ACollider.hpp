...
namespace wd
{
    class ACollider : public wd::ICollider {
        public:
            ...
            virtual void    onTriggerEnter(std::shared_ptr<wd::IGameObject>, wd::IGameObject *);
            virtual void    onTriggerExit(std::shared_ptr<wd::IGameObject>, wd::IGameObject *);
            virtual void    onTriggerStay(std::shared_ptr<wd::IGameObject>, wd::IGameObject *);

            // Update member function
            virtual void    Update(const std::vector<std::shared_ptr<wd::IGameObject>> &, wd::IGameObject *);
