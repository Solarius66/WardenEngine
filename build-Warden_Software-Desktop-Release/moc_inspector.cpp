...
#include "../Warden_Software/inspector.h"
...
const QMetaObject Inspector::staticMetaObject = {
    { &QVBoxLayout::staticMetaObject, qt_meta_stringdata_Inspector.data,
      qt_meta_data_Inspector,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
